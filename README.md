...
In the low-gain op-amp circuit, $R_i$ and $R_f$ were measured to calculate an expected gain from the circuit when compared to the gain calculated from measuring $V_i$ and $V_o$ at a constant voltage. The expected gain from resistance was -0.993 while the gain from the measured cwas For the moderate-gain op-amp circuit and high-gain op-amp circuit, $V_i$ and $V_o$ were measured and used to calcult
